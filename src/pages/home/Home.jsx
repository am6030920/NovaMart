      ...
      <section style={{ background: "#fff", marginTop: "5px" }}>
        ...
        <div className="container" style={{ paddingTop: "25px", paddingBottom: "25px" }}>
          ...
          <section style={{ padding: "10px 0" }}>
            ...
            >
              <div>
                <h2 style={{ fontSize: "25px", marginBottom: "3px", display: "flex", alignItems: "center", gap: "5px" }}>
                  Popular Products <MdOutlineShoppingCart />
                </h2>
                <p style={{ marginTop: "0px", color: "black", fontSize: "15px" }}>
                  Do not miss the current offers until the end of the Year....
                </p>
              </div>

              {/* RIGHT TAB FILTER */}
              <Box sx={{ maxWidth: { xs: 200, sm: 480 }, bgcolor: 'background.paper' }}>
                <Tabs
                  value={value}
